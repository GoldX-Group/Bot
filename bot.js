...
if (!DISCORD_TOKEN || !GUILD_ID || !VOICE_CHANNEL_ID) {
  ...
  throw new Error(
    ...
    'Missing Discord configuration. Define DISCORD_TOKEN, GUILD_ID y VOICE_CHANNEL_ID en tu .env.'
  ...
  const embed = new EmbedBuilder()
    ...
    .setAuthor({
      ...
      iconURL:
        ...
        'https://media.discordapp.net/attachments/1461000295814267124/1466688323019083850/Gemini_Generated_Image_69mrel69mrel69mr.png?ex=697da771&is=697c55f1&hm=a24cec97861685a0ad42bc50d5028f16d4057f62f41dbc6632e9000ff312f736&=&format=webp&quality=lossless&width=768&height=768',
